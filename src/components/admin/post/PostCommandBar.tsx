      ...
      <div className="flex flex-col gap-4">
            ...
            {hasRestorableDraft && (
              <div className="flex flex-wrap items-center gap-2 text-[11px] text-[var(--text-muted)]">
                ...
                <button
                  ...
                  className="rounded-lg border border-[color:var(--border)] px-2.5 py-1 text-[var(--text)] transition hover:border-[color:var(--accent)]"
                >
                  복구
                </button>
                <button
                  ...
                  className="rounded-lg border border-[color:var(--border)] px-2.5 py-1 transition hover:border-red-300 hover:text-red-500"
                >
                  삭제
                </button>
              </div>
        ...
        <div className="flex flex-wrap items-center gap-2">
          <button
            ...
            className="inline-flex items-center gap-2 rounded-lg border border-[color:var(--border)] bg-[var(--surface)] px-4 py-2 text-xs font-semibold text-[var(--text)] transition hover:border-[color:var(--accent)] hover:text-[var(--accent-strong)]"
          >
          ...
          {activeId && (
            <button
              type="button"
              onClick={onDelete}
              className="inline-flex items-center gap-2 rounded-lg border border-red-200 bg-white px-4 py-2 text-xs font-semibold text-red-500 transition hover:bg-red-50"
            >
              <Trash2 size={14} />
              삭제
            </button>
