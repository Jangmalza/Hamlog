        ...
        <div className="mt-6 grid gap-4 border-t border-[color:var(--border)] pt-6 md:grid-cols-12 bg-transparent">
            ...
            <div className="md:col-span-6 relative group">
                ...
                <CategoryPicker
                    ...
                    triggerClassName="flex w-full items-center justify-between rounded-xl border border-[color:var(--border)] bg-[var(--surface-muted)] px-3 py-2 text-sm text-[var(--text)] transition-colors hover:border-[color:var(--accent)]"
